...
# Keep LayoutInflater and its members (needed for reflection and layout inflation)
-keep class android.view.LayoutInflater {
    public *;
    protected *;
}

# Keep all DataBinding/ViewBinding generated classes
...
# Keep BR class (data binding IDs)
-keep class **.BR {
    <fields>;
}
